...
--
-- Host: 127.0.0.1
-- Generation Time: 15-Set-2014 às 18:19
...
CREATE TABLE IF NOT EXISTS `tb_anamnese` (
  ...
  `cd_nutricionista` int(11) DEFAULT NULL,
  `cd_entrevistado` int(11) DEFAULT NULL,
  ...
  `cd_perfilalimentar` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_entrevistado` (
  ...
  UNIQUE KEY `uk_Matricula` (`nr_matricula`)
...
INSERT INTO `tb_instituicao` (`cd_instituicao`, `nm_instituicao`, `nm_campi`, `nm_logradouro`, `cd_cidade`, `cd_estado`) VALUES
(1, 'Instituto Federal de Educação, Ciência e Tecnologia da Paraíba', 'Campus Campina Grande', 'Avenida Tranquilino Coelho Lemos, 671, DinamÃ©rica', 7, 25);
...
CREATE TABLE IF NOT EXISTS `tb_nutricionista` (
  ...
  `cd_usuario` int(11) NOT NULL,
  `nm_crn` int(11) NOT NULL,
  `cd_instituicao` int(11) NOT NULL,
  `dt_registro` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `nm_siape` int(11) NOT NULL,
...
--
-- Extraindo dados da tabela `tb_percentil`
--
...
--
-- Estrutura da tabela `tb_perfilalimentar`
--
...
INSERT INTO `tb_pesquisa` (`cd_pesquisa`, `nm_pesquisa`, `dt_inicio`, `dt_fim`, `cd_instituicao`, `cd_nutricionista`, `dt_registro`) VALUES
(1, '2014.1', '2014-06-16', '2014-08-20', 1, 1, '2014-06-16 19:35:37');
...
INSERT INTO `tb_tipousuario` (`cd_tipousuario`, `nm_tipousuario`, `dt_registro`) VALUES
(1, 'Nutricionista', '2014-06-16 19:50:57'),
(2, 'Aluno', '2014-06-16 19:50:57');
...
CREATE TABLE IF NOT EXISTS `tb_usuario` (
  ...
  `vl_authkey` varchar(32) NOT NULL,
  `nm_usuario` varchar(255) NOT NULL,
  `dt_nascimento` date NOT NULL,
  `nm_sexo` varchar(1) NOT NULL,
  `cd_tipousuario` char(1) NOT NULL,
  `fl_ativo` tinyint(1) NOT NULL DEFAULT '1',
  `dt_registro` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`cd_usuario`),
  UNIQUE KEY `uk_Login` (`nm_login`)
