...
public class Questionario18Activity extends Activity implements OnClickListener {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_questionario18);
	...
	public void onClick(View arg0) {
			...
			RadioButton radio1 = (RadioButton) findViewById(R.id.quest18op1);
			RadioButton radio2 = (RadioButton) findViewById(R.id.quest18op2);
			RadioButton radio3 = (RadioButton) findViewById(R.id.quest18op3);
			RadioButton radio4 = (RadioButton) findViewById(R.id.quest18op4);
			...
			Intent i = new Intent(this, ResultadoQuestionarioActivity.class);
            startActivity(i);
