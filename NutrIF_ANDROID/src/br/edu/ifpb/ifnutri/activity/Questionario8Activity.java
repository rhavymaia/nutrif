...
public class Questionario8Activity extends Activity implements OnClickListener {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_questionario8);
	...
	public void onClick(View arg0) {
			...
			RadioButton radio1 = (RadioButton) findViewById(R.id.quest8op1);
			RadioButton radio2 = (RadioButton) findViewById(R.id.quest8op2);
			RadioButton radio3 = (RadioButton) findViewById(R.id.quest8op3);
			RadioButton radio4 = (RadioButton) findViewById(R.id.quest8op4);
			...
			Intent i = new Intent(this, Questionario9Activity.class);
            startActivity(i);
