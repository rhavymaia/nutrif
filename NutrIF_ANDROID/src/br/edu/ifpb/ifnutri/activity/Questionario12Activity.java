...
public class Questionario12Activity extends Activity implements OnClickListener {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_questionario12);
	...
	public void onClick(View arg0) {
			...
			RadioButton radio1 = (RadioButton) findViewById(R.id.quest12op1);
			RadioButton radio2 = (RadioButton) findViewById(R.id.quest12op2);
			RadioButton radio3 = (RadioButton) findViewById(R.id.quest12op3);
			...
			Intent i = new Intent(this, Questionario13Activity.class);
            startActivity(i);
