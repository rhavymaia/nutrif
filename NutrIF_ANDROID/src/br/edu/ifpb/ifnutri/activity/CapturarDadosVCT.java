...
public class CapturarDadosVCT extends Activity implements OnClickListener {
	...
	public void onClick(View arg0) {
		...
		if (val1 == true && val2 == true) {
			...
			try {
				...
				jsonObjectEntrevistado.put("nascimento",nasc );
				jsonObjectEntrevistado.put("sexo",sexo );
				...
				VCTAsyncTask LogAsyncTask = new VCTAsyncTask(this);
