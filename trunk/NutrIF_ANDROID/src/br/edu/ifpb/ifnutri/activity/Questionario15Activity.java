...
public class Questionario15Activity extends Activity implements OnClickListener {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_questionario15);
	...
	public void onClick(View arg0) {
			...
			RadioButton radio1 = (RadioButton) findViewById(R.id.quest15op1);
			RadioButton radio2 = (RadioButton) findViewById(R.id.quest15op2);
			RadioButton radio3 = (RadioButton) findViewById(R.id.quest15op3);
			RadioButton radio4 = (RadioButton) findViewById(R.id.quest15op4);
			...
			Intent i = new Intent(this, Questionario16Activity.class);
            startActivity(i);
