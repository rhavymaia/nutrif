...
public class Questionario7Activity extends Activity implements OnClickListener {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_questionario7);
	...
	public void onClick(View arg0) {
			...
			RadioButton radio1 = (RadioButton) findViewById(R.id.quest7op1);
			RadioButton radio2 = (RadioButton) findViewById(R.id.quest7op2);
			RadioButton radio3 = (RadioButton) findViewById(R.id.quest7op3);
			RadioButton radio4 = (RadioButton) findViewById(R.id.quest7op4);
			...
			Intent i = new Intent(this, Questionario8Activity.class);
            startActivity(i);
