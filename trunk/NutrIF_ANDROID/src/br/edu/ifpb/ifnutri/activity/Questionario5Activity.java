...
public class Questionario5Activity extends Activity implements OnClickListener {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_questionario5);
	...
	public void onClick(View arg0) {
			...
			RadioButton radio1 = (RadioButton) findViewById(R.id.quest5op1);
			RadioButton radio2 = (RadioButton) findViewById(R.id.quest5op2);
			RadioButton radio3 = (RadioButton) findViewById(R.id.quest5op3);
			RadioButton radio4 = (RadioButton) findViewById(R.id.quest5op4);
			...
			Intent i = new Intent(this, Questionario6Activity.class);
            startActivity(i);
