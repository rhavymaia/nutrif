...
<div class="container">
    ...
    <form method="post" action="trataPerfilAlimentarParte2.php">
        ...
        <h2>Qual é, em média, a quantidade de carnes (gado, porco, aves, 
            peixes e outras) ou ovos que você come por dia dia?</h2>
        <label for="quest5_1">
        ...
        <h2>Você costuma tirar a gordura aparente das carnes, a 
            pele do frango ou outro tipo de ave?</h2>
        <label for="quest6_1">
        ...
        <h2>Você costuma comer peixes com qual frequência?</h2>
        <label for="quest7_1">
        ...
        <h2>Qual é, em média, a quantidade de leite e seus derivados 
            (iogurtes, bebidas lácteas, coalhada, requeijão, queijos 
            e outros) que você come por dia?</h2>
        <h3>Pense na quantidade usual que você consome: pedaço, fatia ou 
            porções em colheres de sopa ou copo grande (tamanho do copo 
            de requeijão) ou xícara grande, quando for o caso.</h3>            
        <label for="quest8_1">
        ...
        <div id="questao9">
            <h2>Que tipo de leite e seus derivados você habitualmente 
                consome?</h2>
            <label for="quest9_1">
